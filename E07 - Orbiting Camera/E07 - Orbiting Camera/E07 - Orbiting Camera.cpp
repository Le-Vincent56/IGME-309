...
const char meshFile[128] = "C:/Users/levin/source/repos/IGME-309/E07 - Orbiting Camera/Mesh/bunny2k.obj";
...
void idle()
{
	...
	// Update the theta variable to determine the orbit angle.
	theta += deltaTime * 0.5f;

	// Use theta for new cam_x and cam_z values
